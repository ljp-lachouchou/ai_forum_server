...
from ai.db.collection_names import word_collection_name, article_collection_name
...
from ai.rag.rag_wrapper import content_mapper, title_mapper
...
async def test():
    ...
    await manager.start_process(word_collection_name,example_word,content_mapper)
